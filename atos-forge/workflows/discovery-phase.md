...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /forge:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/atos-forge/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/atos-forge/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/atos-forge/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/atos-forge/templates/discovery.md
...
Use ~/.claude/atos-forge/templates/discovery.md.
...
1. Discuss phase context (/forge:discuss-phase [current-phase])
2. Create phase plan (/forge:plan-phase [current-phase])
