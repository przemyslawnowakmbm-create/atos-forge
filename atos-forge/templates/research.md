...
**CRITICAL:** If CONTEXT.md exists from /forge:discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches A-Forge templates)
