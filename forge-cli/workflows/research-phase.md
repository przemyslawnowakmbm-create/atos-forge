...
@~/.claude/forge-cli/references/model-profile-resolution.md
...
@~/.claude/forge-cli/references/phase-argument-parsing.md
...
node ~/.claude/forge-cli/bin/forge-tools.cjs state-snapshot | jq '.decisions'
```
