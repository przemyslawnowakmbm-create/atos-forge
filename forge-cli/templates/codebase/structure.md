...
**New Template:**
- Implementation: `forge-cli/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `forge-cli/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/forge-cli/workflows/{name}.md`

**New Reference Document:**
- Implementation: `forge-cli/references/{name}.md`
